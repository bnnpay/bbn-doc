...
В случае успеха, возвращается список банков (Id, название, минимальный лимит одной заявки, максимальный лимит одной заявки).
...
### Подтвердить оплату фиатной заявки
