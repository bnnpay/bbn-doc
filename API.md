...
### Создать аппеляцию на фиатную заявку приема средств

`POST /order/appeal`

Метод создания аппеляции на заявку оплаты. Если оператор подтверждает аппеляцию, вы получите коллбек успешной заявки.
...
```<json>   
{
  "OrderId":"543543534464564564564564646454564564",
  "Amount":10.0,
