...
Получить заявку по Hash. В параметрах можно передать страницу пагинация, по умолчанию page=1.
...
### Получить реквизиты заявки

`GET /order/bankdetail`
...
{
  "success": true,
  "result": "У заявки нет реквизитов"
}
```
